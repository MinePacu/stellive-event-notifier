...
final class MockHubStore: ObservableObject {
    ...
    private(set) var members: [HubMember] = [
        .init(id: "ayatsuno-yuni", koreanName: "아야츠노 유니", englishName: "Ayatsuno Yuni", generationId: "gen1", generationName: "1기생", unitName: "Everys", catalogRole: .member, roleLabel: nil, isPerson: true, chzzkChannelId: "45e71a76e949e16a34764deb962f9d9f", youtubeHandle: "@ayatsunoyuni", isLive: true, notificationEnabled: true, realtimeEnabled: true, liveStartedAt: Date(timeIntervalSince1970: 1_780_390_800), liveCategory: "Just Chatting"),
        .init(id: "sakihane-huya", koreanName: "사키하네 후야", englishName: "Sakihane Huya", generationId: "gen1", generationName: "1기생", unitName: "Everys", catalogRole: .member, roleLabel: nil, isPerson: true, chzzkChannelId: "36ddb9bb4f17593b60f1b63cec86611d", youtubeHandle: "@Sakihanechannel", isLive: false, notificationEnabled: true, realtimeEnabled: false),
        .init(id: "shirayuki-hina", koreanName: "시라유키 히나", englishName: "Shirayuki Hina", generationId: "gen2", generationName: "2기생", unitName: "Universe", catalogRole: .member, roleLabel: nil, isPerson: true, chzzkChannelId: "b044e3a3b9259246bc92e863e7d3f3b8", youtubeHandle: "verify_required", isLive: false, notificationEnabled: true, realtimeEnabled: false),
        .init(id: "neneko-mashiro", koreanName: "네네코 마시로", englishName: "Neneko Mashiro", generationId: "gen2", generationName: "2기생", unitName: "Universe", catalogRole: .member, roleLabel: nil, isPerson: true, chzzkChannelId: "4515b179f86b67b4981e16190817c580", youtubeHandle: "verify_required", isLive: false, notificationEnabled: true, realtimeEnabled: false),
        .init(id: "akane-lize", koreanName: "아카네 리제", englishName: "Akane Lize", generationId: "gen2", generationName: "2기생", unitName: "Universe", catalogRole: .member, roleLabel: nil, isPerson: true, chzzkChannelId: "4325b1d5bbc321fad3042306646e2e50", youtubeHandle: "verify_required", isLive: false, notificationEnabled: true, realtimeEnabled: false),
        .init(id: "arahashi-tabi", koreanName: "아라하시 타비", englishName: "Arahashi Tabi", generationId: "gen2", generationName: "2기생", unitName: "Universe", catalogRole: .member, roleLabel: nil, isPerson: true, chzzkChannelId: "a6c4ddb09cdb160478996007bff35296", youtubeHandle: "verify_required", isLive: false, notificationEnabled: true, realtimeEnabled: false),
        .init(id: "tenko-shibuki", koreanName: "텐코 시부키", englishName: "Tenko Shibuki", generationId: "gen3", generationName: "3기생", unitName: "Cliche", catalogRole: .member, roleLabel: nil, isPerson: true, chzzkChannelId: "64d76089fba26b180d9c9e48a32600d9", youtubeHandle: nil, isLive: false, notificationEnabled: true, realtimeEnabled: false),
        .init(id: "aokumo-rin", koreanName: "아오쿠모 린", englishName: "Aokumo Rin", generationId: "gen3", generationName: "3기생", unitName: "Cliche", catalogRole: .member, roleLabel: nil, isPerson: true, chzzkChannelId: "516937b5f85cbf2249ce31b0ad046b0f", youtubeHandle: nil, isLive: false, notificationEnabled: true, realtimeEnabled: false),
        .init(id: "hanako-nana", koreanName: "하나코 나나", englishName: "Hanako Nana", generationId: "gen3", generationName: "3기생", unitName: "Cliche", catalogRole: .member, roleLabel: nil, isPerson: true, chzzkChannelId: "4d812b586ff63f8a2946e64fa860bbf5", youtubeHandle: nil, isLive: false, notificationEnabled: true, realtimeEnabled: false),
        .init(id: "yuzuha-riko", koreanName: "유즈하 리코", englishName: "Yuzuha Riko", generationId: "gen3", generationName: "3기생", unitName: "Cliche", catalogRole: .member, roleLabel: nil, isPerson: true, chzzkChannelId: "8fd39bb8de623317de90654718638b10", youtubeHandle: nil, isLive: false, notificationEnabled: true, realtimeEnabled: false),
        .init(id: "gangzi", koreanName: "강지", englishName: "Gangzi", generationId: "gamja", generationName: "감자", unitName: "감자", catalogRole: .representative, roleLabel: "스텔라이브 대표", isPerson: true, chzzkChannelId: "b5ed5db484d04faf4d150aedd362f34b", youtubeHandle: "@GANGZI1", isLive: false, notificationEnabled: true, realtimeEnabled: false),
        .init(id: "stellive-official", koreanName: "스텔라이브 공식", englishName: "Stellive Official", generationId: "official", generationName: "기타", unitName: "공식 채널", catalogRole: .officialChannel, roleLabel: "스텔라이브 공식 채널", isPerson: false, chzzkChannelId: nil, youtubeHandle: "@stellive_official", isLive: false, notificationEnabled: true, realtimeEnabled: true),
        .init(id: "gen4-placeholder", koreanName: "4기생 placeholder", englishName: "Generation 4 Placeholder", generationId: "gen4-upcoming", generationName: "4기생", unitName: "upcoming", catalogRole: .placeholder, roleLabel: nil, activeStatus: .upcoming, isPerson: false, chzzkChannelId: nil, youtubeHandle: nil, isLive: false, notificationEnabled: false, realtimeEnabled: false)
    ]
    ...
    let hubEvents: [HubEvent] = [
        ...
        .init(
            id: "star-trail-festival-2025",
            category: .offlineConcert,
            participationMode: .offline,
            status: .ended,
            title: "2025 THE FIRST STELLIVE FESTIVAL <STAR TRAIL>",
            summary: "스텔라이브 9명이 함께한 첫 번째 단체 콘서트.",
            memberId: nil,
            generationId: "official",
            sourceUrl: "https://stellive.me/news/7624",
            sourceLabel: "Stellive Official",
            sourceType: .official,
            announcedAt: ISO8601DateFormatter().date(from: "2025-10-02T20:07:00+09:00"),
            startsAt: ISO8601DateFormatter().date(from: "2025-12-20T18:00:00+09:00"),
            endsAt: nil,
            purchaseUrl: nil,
            ticketUrl: "https://ticket.melon.com/performance/index.htm?prodId=211981",
            venueName: "일산 킨텍스 제2전시관 9홀",
            venueAddress: nil,
            notificationEligible: true,
            updatedAt: ISO8601DateFormatter().date(from: "2025-12-20T18:00:00+09:00") ?? Date(timeIntervalSince1970: 0)
        ),
        .init(
            id: "akane-lize-ovt-solo-concert",
            category: .offlineConcert,
            participationMode: .offline,
            status: .ended,
            title: "AKANE LIZE : OVT. FIRST SOLO CONCERT",
            summary: "아카네 리제의 첫 단독 콘서트.",
            memberId: "akane-lize",
            generationId: "gen2",
            sourceUrl: "https://stellive.me/news/11721",
            sourceLabel: "Stellive Official",
            sourceType: .official,
            announcedAt: nil,
            startsAt: ISO8601DateFormatter().date(from: "2026-07-11T18:00:00+09:00"),
            endsAt: nil,
            purchaseUrl: nil,
            ticketUrl: "https://ticket.melon.com/performance/index.htm?prodId=213346",
            venueName: "고려대학교 화정체육관",
            venueAddress: nil,
            notificationEligible: true,
            updatedAt: ISO8601DateFormatter().date(from: "2026-07-11T18:00:00+09:00") ?? Date(timeIntervalSince1970: 0)
        ),
        .init(
            id: "sakihane-huya-3d-debut",
            category: .onlineCollab,
            participationMode: .online,
            status: .upcoming,
            title: "사키하네 후야 3D 데뷔",
            summary: "사키하네 후야의 3D 데뷔 방송입니다.",
            memberId: "sakihane-huya",
            generationId: "gen1",
            sourceUrl: "https://x.com/StelLive_kr/status/2098335807962800467",
            sourceLabel: "Stellive Official",
            sourceType: .official,
            announcedAt: ISO8601DateFormatter().date(from: "2026-09-11T18:00:00+09:00"),
            startsAt: ISO8601DateFormatter().date(from: "2026-09-18T18:00:00+09:00"),
            endsAt: nil,
            purchaseUrl: nil,
            ticketUrl: nil,
            venueName: "사키하네 후야 CHZZK 채널",
            venueAddress: nil,
            notificationEligible: true,
            updatedAt: ISO8601DateFormatter().date(from: "2026-09-11T18:00:00+09:00") ?? Date(timeIntervalSince1970: 0)
        )
    ]

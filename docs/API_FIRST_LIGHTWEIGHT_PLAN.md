...
- **X:** Use official X API v2 Filtered Stream when available. If unavailable or too expensive, use safe rate-limited polling or disable the integration behind a feature flag.
...
- Confirm allowed production CHZZK API method and X API access level.

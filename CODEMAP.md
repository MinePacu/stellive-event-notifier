...
- `android/StelliveHubAndroid/app/src/main/java/dev/stellive/hub/ui/chrome/MainScreenChromePolicy.kt` - Root/detail screen header, scroll-title, and top action visibility policy.
- `android/StelliveHubAndroid/app/src/main/java/dev/stellive/hub/ui/components/HubCardFactory.kt` - Shared semantic Android card styles.
- `android/StelliveHubAndroid/app/src/main/java/dev/stellive/hub/ui/components/SectionHeaderView.kt` - Shared external section/date header.
- `android/StelliveHubAndroid/app/src/main/java/dev/stellive/hub/ui/components/TopFilterStripPolicy.kt` - Filter group data and equal-width/scroll layout policy.
- `android/StelliveHubAndroid/app/src/main/java/dev/stellive/hub/ui/components/TopFilterStripView.kt` - Fixed top filter strip renderer and scroll-position preservation.
- `android/StelliveHubAndroid/app/src/test/java/dev/stellive/hub/MainScreenChromePolicyTest.kt` - Screen chrome behavior tests.
- `android/StelliveHubAndroid/app/src/test/java/dev/stellive/hub/TopFilterStripPolicyTest.kt` - Filter strip layout policy tests.

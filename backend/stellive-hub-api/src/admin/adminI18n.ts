...
export const enAdminMessages = {
  ...
  "login.overviewAria": "Admin access overview",
  "login.console": "Admin console",
  "login.hero": "Secure access for hub operations.",
  "login.description": "Dashboard is for status review, Hub events is for publishing work, and Settings keeps tokens and console preferences separated from the login step.",
  "login.sessionFirst": "Admin session first",
  "login.sessionDescription": "Sign in with the admin console token to open the server-rendered console.",
  "login.internalLater": "Internal token later",
  "login.internalDescription": "Enter the Internal API bearer token after login in Settings when an internal operation needs it.",
  "login.signIn": "Sign in",
  "login.sessionOnly": "Admin session access only.",
...
export const koAdminMessages: Record<AdminMessageKey, string> = {
  ...
  "login.title": "스텔라이브 허브 관리자 로그인", "login.mainAria": "스텔라이브 허브 관리자 로그인", "login.overviewAria": "관리자 접근 안내", "login.console": "관리자 콘솔", "login.hero": "허브 운영을 위한 안전한 접근.", "login.description": "대시보드에서 상태를 확인하고, 허브 이벤트에서 게시 작업을 하며, 설정에서 내부 토큰과 콘솔 환경설정을 로그인 단계와 분리해 관리합니다.", "login.sessionFirst": "관리자 세션 먼저", "login.sessionDescription": "관리자 콘솔 토큰으로 로그인해 서버 렌더링 콘솔을 엽니다.", "login.internalLater": "내부 토큰은 로그인 후", "login.internalDescription": "내부 작업이 필요할 때 로그인 후 설정에서 내부 API Bearer 토큰을 입력합니다.", "login.signIn": "로그인", "login.sessionOnly": "관리자 세션 전용 접근입니다.", "login.token": "관리자 콘솔 토큰", "login.tokenPlaceholder": "관리자 콘솔 토큰 입력",
